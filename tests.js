...
Linkedin = {
  config: {
    ...
    addNote: true,
    note: "Bonjour {{name}}, Prêt à donner vie à votre projet de création d’entreprise ? Avant de foncer tête baissée, il y a une étape cruciale à ne pas négliger : la prévision financière. Nous sommes des pros de cette étape essentielle. Venez vérifier la faisabilité économique de votre projet. A très vite ! Norbert www.previsionnel.net",
  },
